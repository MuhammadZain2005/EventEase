...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewentrants); // your XML layout
        ...
        entrantsRef = firestore.collection("entrants"); // your Firestore collection
    ...
    private void loadEntrantsFromFirestore() {
        entrantsRef.addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                if (error != null) {
                    Toast.makeText(MainActivity.this, "Failed to load entrants.", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void removeCancelledEntrants() {
        entrantsRef.whereEqualTo("status", "cancelled")
                .get()
                .addOnSuccessListener(querySnapshot -> {
                    for (QueryDocumentSnapshot doc : querySnapshot) {
                        doc.getReference().delete();
                    }
                    Toast.makeText(MainActivity.this, "Cancelled entrants removed.", Toast.LENGTH_SHORT).show();
                })
                .addOnFailureListener(e -> Toast.makeText(MainActivity.this, "Failed to remove cancelled entrants.", Toast.LENGTH_SHORT).show());
    }
}
